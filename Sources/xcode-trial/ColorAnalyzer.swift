...
class ColorAnalyzer {
  ...
  func analyzeColorPalette() -> [(
    ...
    print("  ✅ Analyzed colors in \(colorAnalyses.count) frames")
  ...
  private func analyzeColorConsistency(
    ...
    print("    Palette stability: \(String(format: "%.1f", paletteStability))%")
    print("    Color changes detected: \(paletteChanges)")
